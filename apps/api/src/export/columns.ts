 ...
 *
 * Deliberately short: position, company, date, status and notes. This is a list of what
 * you applied for, not a report about it — anything analytical belongs in the app, where
 * it can be interactive, rather than frozen into a spreadsheet cell.
 *
