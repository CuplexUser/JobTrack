...
It knows what you are looking for (`get_profile`, `update_profile`) and ranks your saved
openings against it (`rank_openings`). It keeps track of your network too (`list_contacts`, `log_interaction`, `link_contact` and
